...
#define Support @"帝步凡"
@interface CdyWBViewController ()<UIWebViewDelegate,UIActionSheetDelegate,WKNavigationDelegate,WKUIDelegate,UIScrollViewDelegate>
/** 进度条 */
...
@implementation CdyWBViewController
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    ...
    self.supportLabel.text = [NSString stringWithFormat:@"WBView 由 %@ 提供\n%@提供技术支持",webView.URL.host,Support];
